...
namespace WebScraper.Websites.MoonBunnyCafe
{
    class MoonBunnyCafeBookScraper : HtmlBookScraper
    {
        ...
        */
        ...
        public MoonBunnyCafeBookScraper()
        {
            //OriginalDoc = new HtmlDocument();
        }

        public MoonBunnyCafeBookScraper(string oDoc)
        {
            OriginalDoc = new HtmlDocument();
