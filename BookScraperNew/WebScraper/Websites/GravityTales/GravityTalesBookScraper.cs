...
namespace WebScraper.Websites.GravityTales
{
    class GravityTalesBookScraper : HtmlBookScraper
    {
        ...
        */
        ...
        public override string GetNextChapter()
        {
            ...
            string s = "http://gravitytales.com" + this.NextChapterAddress;
        ...
        public override string GetPreviousChapter()
        {
            ...
            string s = "http://gravitytales.com" + this.PreviousChapterAddress;
        ...
        public GravityTalesBookScraper()
        {
            //OriginalDoc = new HtmlDocument();
        }

        public GravityTalesBookScraper(string oDoc)
        {
            OriginalDoc = new HtmlDocument();
