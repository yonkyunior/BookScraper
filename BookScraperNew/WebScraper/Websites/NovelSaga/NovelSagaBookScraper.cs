...
namespace WebScraper.Websites.NovelSaga
{
    class NovelSagaBookScraper : HtmlBookScraper
    {
        ...
        */
        ...
        public override string GetNextChapter()
        {
            ...
            bool v1 = !index2.Equals("http://novelsaga.com");
            bool v2 = !index.Equals("http://www.novelsaga.com");

            string s;

            if (index2.Equals("http://novelsaga.com") || index.Equals("http://www.novelsaga.com"))
            {
                s = this.NextChapterAddress;
            }
            else
            {
                s = "http://novelsaga.com" + this.NextChapterAddress;
            }
        ...
        public NovelSagaBookScraper()
        {
            //OriginalDoc = new HtmlDocument();
        }

        public NovelSagaBookScraper(string oDoc)
        {
            OriginalDoc = new HtmlDocument();
