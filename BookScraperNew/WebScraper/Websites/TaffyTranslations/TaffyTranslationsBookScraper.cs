...
namespace WebScraper.Websites.TaffyTranslations
{
    class TaffyTranslationsBookScraper : HtmlBookScraper
    {
        ...
        */
        ...
        public TaffyTranslationsBookScraper()
        {
            //OriginalDoc = new HtmlDocument();
        }

        public TaffyTranslationsBookScraper(string oDoc)
        {
            OriginalDoc = new HtmlDocument();
